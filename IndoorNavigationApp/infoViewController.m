...
- (void)viewDidLoad {
    ...
    email.center = CGPointMake(105,195);
    ...
    // setting imageview
    UIImageView* img = [[UIImageView alloc] initWithFrame:CGRectMake(53, 20, 100,95)];
